...
return [
    ...
    'title' => 'PESAT API Documentation',

    // A short description of your API. Will be included in the docs webpage, Postman collection and OpenAPI spec.
    'description' => 'Dokumentasi API untuk Sistem Informasi Pengawasan Smart City (PESAT) - GEMASTIK 2026',

    // Text to place in the "Introduction" section, right after the `description`. Markdown and HTML are supported.
    'intro_text' => <<<'INTRO'
            Dokumentasi ini menyediakan referensi untuk berintegrasi dengan API PESAT.
            Sistem ini mencakup endpoint untuk pengiriman telemetri AI dari edge device, laporan warga, serta pengaturan sistem.
        INTRO,
    ...
    'auth' => [
        ...
        'extra_info' => 'Gunakan Bearer Token yang didapatkan dari konfigurasi edge device.',
    ],
