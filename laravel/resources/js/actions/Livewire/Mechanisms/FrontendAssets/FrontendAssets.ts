 ...
 * @route '/livewire-cfe46b34/livewire.js'
 */
...
returnJavaScriptAsFile.definition = {
    methods: ["get","head"],
    url: '/livewire-cfe46b34/livewire.js',
 ...
 * @route '/livewire-cfe46b34/livewire.min.js.map'
 */
...
maps.definition = {
    methods: ["get","head"],
    url: '/livewire-cfe46b34/livewire.min.js.map',
} satisfies RouteDefinition<["get","head"]>
 ...
 * @route '/livewire-cfe46b34/livewire.csp.min.js.map'
 */
...
cspMaps.definition = {
    methods: ["get","head"],
    url: '/livewire-cfe46b34/livewire.csp.min.js.map',
} satisfies RouteDefinition<["get","head"]>
